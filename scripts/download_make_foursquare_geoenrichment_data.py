...
if __name__ == "__main__":
    ...
    raw_pth = Path(__file__).parent.parent / 'data' / 'raw' / 'foursquare_geoenrichment'
    if raw_pth.exists():
    ...
    subprocess.run(f'aws s3 cp s3://esri-data-main/processed/delivery/foursquare_geoenrichment/ {str(raw_pth)} --recursive')
